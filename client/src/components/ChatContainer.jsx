...
const ChatContainer = () => {
  ...
  // Filter messages for selected user (replace with your logic if needed)
  const userMessages = messagesDummyData.filter(
  ...
  return (
    <div className='h-full overflow-scroll relative backdrop-blur-lg'>
      ...
      <div className='flex items-center gap-3 py-3 mx-4 border-b border-stone-500'>
        ...
        <img className='md:hidden max-w-7'
          onClick={() => setSelectedUser(null)} src={assets.arrow_icon} alt='' />
